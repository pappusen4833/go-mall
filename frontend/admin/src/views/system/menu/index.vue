      ...
      <el-form ref="form" :inline="true" :model="form" :rules="rules" size="small" label-width="80px">
        ...
        <el-form-item v-show="form.type.toString() === '1'" label="菜单缓存" prop="cache">
          <el-radio-group v-model="form.cache" size="mini">
            <el-radio-button :abel="1">是</el-radio-button>
            <el-radio-button :label="0">否</el-radio-button>
          </el-radio-group>
        </el-form-item>
        ...
        <el-form-item v-show="form.type.toString() !== '0'" label="操作路由" prop="router">
          <el-input v-model="form.router" :disabled="form.iframe" placeholder="操作路由" style="width: 178px;" />
        </el-form-item>
        <el-form-item v-show="form.type.toString() !== '0'" label="路由动作" prop="routerMethod">
          <el-input v-model="form.routerMethod" :disabled="form.iframe" placeholder="路由动作（get/post）" style="width: 178px;" />
        </el-form-item>
