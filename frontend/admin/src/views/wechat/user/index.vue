<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="data" size="small" style="width: 100%;">
      ...
      <el-table-column  prop="createTime" label="创建日期" width="140" show-overflow-tooltip>
        <template slot-scope="scope">
      ...
      <el-table-column v-if="checkPermission(['admin','YXUSER_ALL','wxuser:edit','YXUSER_DELETE'])" label="操作" width="215" align="center" fixed="right">
        <template slot-scope="scope">
          <!-- <el-button
            v-permission="['admin','YXUSER_ALL','wxuser:edit']"
            size="mini"
            type="danger"
          ...
          <el-dropdown size="mini" split-button type="primary" trigger="click">
            ...
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item>
                <el-button
                  v-permission="['admin','wxuser:edit','YXUSER_EDIT']"
                  size="mini"
                  type="primary"
...
import { del, onStatus } from '@/api/wechat/yxUser'
