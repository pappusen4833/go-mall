...
import (
	...
	ordervo "go-mall/app/services/order_service/vo"
	userVO "go-mall/app/services/wechat_user_service/vo"
...
func getOrderPriceGroup(cartInfo []cartVo.Cart, userAddress *models.UserAddress) orderDto.PriceGroup {
	var (
